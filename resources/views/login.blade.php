...
<body class="d-flex align-items-center py-4 h-100 text-center form-bodyy text-dark">
    <main class="w-100 m-auto form-container border border-secondary rounded-4">
        <form class="">
